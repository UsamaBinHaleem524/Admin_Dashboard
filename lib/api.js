...
export const settingsAPI = {
  ...
  set: (key, value) => apiCall('/settings', { method: 'POST', body: JSON.stringify({ key, value }) }),
};

// Khatas API (for Sales)
export const khatasAPI = {
  getAll: () => apiCall('/khatas'),
  create: (data) => apiCall('/khatas', { method: 'POST', body: JSON.stringify(data) }),
  update: (data) => apiCall('/khatas', { method: 'PUT', body: JSON.stringify(data) }),
  delete: (id) => apiCall(`/khatas?id=${id}`, { method: 'DELETE' }),
};

// Purchase Khatas API (for Purchases)
export const purchaseKhatasAPI = {
  getAll: () => apiCall('/purchase-khatas'),
  create: (data) => apiCall('/purchase-khatas', { method: 'POST', body: JSON.stringify(data) }),
  update: (data) => apiCall('/purchase-khatas', { method: 'PUT', body: JSON.stringify(data) }),
  delete: (id) => apiCall(`/purchase-khatas?id=${id}`, { method: 'DELETE' }),
};
...
export const expensesAPI = {
  ...
  delete: (id) => apiCall(`/expenses?id=${id}`, { method: 'DELETE' }),
};
...
export const personalExpensesAPI = {
  getAll: () => apiCall('/personal-expenses'),
  create: (data) => apiCall('/personal-expenses', { method: 'POST', body: JSON.stringify(data) }),
  update: (data) => apiCall('/personal-expenses', { method: 'PUT', body: JSON.stringify(data) }),
  delete: (id) => apiCall(`/personal-expenses?id=${id}`, { method: 'DELETE' }),
};

// Company Profile API
export const companyProfileAPI = {
  get: () => apiCall('/company-profile'),
  create: (data) => apiCall('/company-profile', { method: 'POST', body: JSON.stringify(data) }),
  update: (data) => apiCall('/company-profile', { method: 'PUT', body: JSON.stringify(data) }),
  delete: (id) => apiCall(`/company-profile?id=${id}`, { method: 'DELETE' }),
};

// Admin Profile API
export const adminProfileAPI = {
  get: () => apiCall('/admin-profile'),
  update: (data) => apiCall('/admin-profile', { method: 'PATCH', body: JSON.stringify(data) }),
}; 