              ...
              <div className="p-6 border-b">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <input
                    ...
                    className="min-w-[28%] px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
              </div>
                    ...
                    {customerBalances.length === 0 ? (
                      ...
                      customerBalances.map((balance) => (
                        <tr key={balance.customer} className="hover:bg-gray-50">
                          <td className="px-6 py-4 whitespace-nowrap font-medium text-gray-900">{balance.customer}</td>
