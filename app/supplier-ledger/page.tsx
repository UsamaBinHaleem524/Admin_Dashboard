      ...
      <div className="space-y-6 px-4 sm:px-6 lg:px-0">
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          {activeTab === "balances" && (
            <div>
              <div className="p-4 sm:p-6 border-b">
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900">Supplier Balances</h3>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full min-w-[640px]">
                  <thead className="bg-gray-50">
                    ...
                    {supplierBalances.length === 0 ? (
                      ...
                      supplierBalances.map((balance) => (
                        <tr key={balance.supplier} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-red-600 font-medium text-sm sm:text-base">
